...
const ref = new Firebase('https://catch-of-the-day-ree.firebaseio.com/');
...
class Inventory extends React.Component {
	...
	authHandler(err, authData){
		...
		storeRef.on('value', (snapshot=> {
			...
			//update our state to reflec the current store owner and user
			this.setState({
				uid: authData.uid,
	...
	render() {
		...
		if(this.state.uid !== this.state.owner){
			return(
					<div><p>Sorry, you aren't the owner of this store</p> {logoutButton}</div>
